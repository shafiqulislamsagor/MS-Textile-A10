...
const Mycard = ({ cardData }) => {
    ...
    const { image, item_name, price, processing_time, rating, short_description , subcategory_Name,  user_name } = cardData
    ...
    return (
        <Card className="p-3 bgColor textWhite">
            ...
            <CardActions className="flex justify-between">
                <div><Link to={`/updatecard/${cardData._id}`} className="btn rounded-md bg-teal-700 text-white">View Details</Link></div>
